...
Можно заметить, что распределение ключей по спискам хеш-таблицы зависит от выбора хеш-функции, используемой для подсчёта хешей элементов. К примеру, хеш-функция, возвращающая на все значения число 1 даст распределение, отличное от того, что получается от хеш-функции, тождественно равной числу 2.
...
## Результаты
Результаты измерений представлены в гистограммах 3 - 11 и таблице 1.

| ![article_assets/distr_const_hash.png](article_assets/distr_const_hash.png) |
| --- |
| *Фигура 1. Гистограмма распределения, даваемого `const_hash`.* |

| ![article_assets/distr_first_char_hash.png](article_assets/distr_first_char_hash.png) |
| --- |
| *Фигура 2. Гистограмма распределения, даваемого `first_char_hash`.* |

| ![article_assets/distr_length_hash.png](article_assets/distr_length_hash.png) |
| --- |
| *Фигура 3. Гистограмма распределения, даваемого `length_hash`.* |

| ![article_assets/distr_sum_hash.png](article_assets/distr_sum_hash.png) |
| --- |
| *Фигура 4. Гистограмма распределения, даваемого `sum_hash`.* |

| ![article_assets/distr_left_shift_hash.png](article_assets/distr_left_shift_hash.png) |
| --- |
| *Фигура 5. Гистограмма распределения, даваемого `left_shift_hash`.* |

| ![article_assets/distr_right_shift_hash.png](article_assets/distr_right_shift_hash.png) |
| --- |
| *Фигура 6. Гистограмма распределения, даваемого `right_shift_hash`.* |

| ![article_assets/distr_murmur_hash.png](article_assets/distr_murmur_hash.png) |
| --- |
| *Фигура 7. Гистограмма распределения, даваемого `murmur_hash`.* |

*Таблица 1. Статистические характеристики распределений. Обозначения: `max length` - максимальная длина списка в таблице, `st. deviation` - среднеквадратическое отклонение длин списков в таблице.*
|               | constant hash | first char hash | length hash | sum hash | left shift hash | right shift hash | murmur hash |
| ------------- | ------------- | --------------- | ----------- | -------- | --------------- | ---------------- | ----------- |
| max length    | 1784          | 269             | 420         | 22       | 15              | 14               | 8           |
| st. deviation | 39.62         | 11.46           | 18.05       | 3.34     | 2.26            | 1.85             | 1.51        |

| ![article_assets/stat_deviation_all.png](article_assets/stat_deviation_all.png) |
| --- |
| *Фигура 8. Сравнительная гистограмма среднеквадратических отклонений длин списков от всех исследованных хеш-функций.* |

| ![article_assets/stat_deviation_optim.png](article_assets/stat_deviation_optim.png) |
| --- |
| *Фигура 9. Сравнительная гистограмма среднеквадратических отклонений длин списков с наименьшим стандартным отклонением.* |

| ![article_assets/stat_max_all.png](article_assets/stat_max_all.png) |
| --- |
| *Фигура 10. Сравнительная гистограмма максимумов длин списков от всех исследованных хеш-функций.* |

| ![article_assets/stat_max_optim.png](article_assets/stat_max_optim.png) |
| --- |
| *Фигура 11. Сравнительная гистограмма максимумов длин списков с наименьшим максимумом длины списков таблицы.* |
